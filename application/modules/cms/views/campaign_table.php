                                                                    ...
                                                                    <table class="table table-striped">
                                                                        ...
                                                                        <?php if(isset($v['short_urls'])): ?>
                                                                                <?php foreach($v['short_urls'] as $x):?>
                                                                                        <tr>
                                                                                                <td><a href="<?php echo site_url('cms/url/'.$x['short_code'])?>" target="_blank"><?php echo $this->config->item('short_url_prefix'); ?><?php echo $x['short_code']?></a></td>
                                                    ...
                                                    <table class="table table-striped">
                                                        ...
                                                        <?php if($shorturls): ?>
                                                            <?php foreach($shorturls as $v): ?>
                                                                    <tr>
                                                                                <td><a href="<?php echo site_url('cms/url/'.$v->short_code)?>" target="_blank"><?php echo $this->config->item('short_url_prefix'); ?><?php echo $v->short_code ?></a></td>
