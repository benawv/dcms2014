...
var short_url_prefix = 'http://some.where/';
     ...
     =============================================================================================*/
            ...
            $(function () {
                ...
                $(document).ready(function() {
                    ...
                    $('.change-read-unread-stream').on('change', function(){
                        ...
                        if($(this).closest('div').prev().find('i').attr('class') == 'icon-facebook'){
                            ...
                            $(this).closest('.containerHeadline').next().load(BASEURL + 'dashboard2/media_stream/facebook_stream/' + social_id + '/' + is_read, function(){
                                $(this).find('.channel-id').val(social_id);
                            });
                        }
                        else if($(this).closest('div').prev().find('i').attr('class') == 'icon-twitter'){
                            $(this).closest('.containerHeadline').next().html('&nbsp;&nbsp;Loading...');        
                            $(this).closest('.containerHeadline').next().load(BASEURL + 'dashboard2/media_stream/twitter_stream/' + social_id + '/' + is_read, function(){
                                $(this).find('.channel-id').val(social_id);
                            });
                        }
                    ...
                    $('.containerHeadline .dropdown-stream-channels').each(function(){
                        ...
                        urlToLoad = BASEURL + 'dashboard2/media_stream/';
                    ...
                    $('.facebook_stream').on('click',function() {
                        ...
                        $(this).closest('.containerHeadline').css( "background-color", "#3B5998" );
                        $(this).closest('.containerHeadline').next().html('&nbsp;&nbsp;Loading...');        
                        $(this).closest('.containerHeadline').next().load(BASEURL + 'dashboard2/media_stream/facebook_stream/' + $(this).siblings('.channel-stream-id').val(),function(){
                            $('.email').tagit({
                                        autocomplete : {
                                            source:  function( request, response ) {
                                                $.ajax({
                    ...
                    $('.twitter_stream').on('click',function() {
                        ...
                        $(this).closest('.containerHeadline').css( "background-color", "#4099FF" );
                        $(this).closest('.containerHeadline').next().html('&nbsp;&nbsp;Loading...');        
                        $(this).closest('.containerHeadline').next().load(BASEURL + 'dashboard2/media_stream/twitter_stream/' + $(this).siblings('.channel-stream-id').val(),function(){
                             $('.email').tagit({
                                        autocomplete : {
                                            source:  function( request, response ) {
                                                $.ajax({
                    ...
                    $('.youtube_stream').on('click',function() {
                        ...
                        $(this).closest('.containerHeadline').css( "background-color", "#FF3333" );
                        $(this).closest('.containerHeadline').next().html('&nbsp;&nbsp;Loading...');
                        $(this).closest('.containerHeadline').next().load(BASEURL + 'dashboard2/media_stream/youtube_stream/' + $(this).siblings('.channel-stream-id').val(),function(){
                             $('.email').tagit({
                                        autocomplete : {
                                            source:  function( request, response ) {
                                                $.ajax({
                            ...
                            if($btnEngagement.attr('item') == 'twitter' || $btnEngagement.attr('item') == 'youtube') return;
                             $.ajax({
                                ...
                                "success" : function(response){
                                    ...
                                    if(response != '')
                                        $btnEngagement.closest('li').find('.engagement-list').html(response);
                                    else
                                        $btnEngagement.closest('li').find('.engagement-list img').hide();
                                    $btnEngagement.BindMultipleSelect();
                                }
                            });
                        }
                ...
                $(this).on('click','.read-mark, .btn-case, .btn-reply, .retweet, .favorit .btn-send-reply, .fblike, .dm_send',
                    ...
                    var me = $(this);
                    $.ajax({
                            url : BASEURL + 'dashboard2/media_stream/ReadUnread',
                            type: "POST",
                            data: {
            ...
            $(".compose-insert-link-btn").click(function(){
                $(".compose-insert-link-text").linkpreview({
                    ...
                    onSuccess: function(data) { //optional
                        ...
                        $.ajax({
                            url : BASEURL + 'dashboard2/media_stream/GenerateShortUrlWithoutCampaign',
                            type: "POST",
                            data: {
                            ...
                            success: function(data){
                                if(data.shortcode){
                                    $('.compose-textbox').val($('.compose-textbox').val()+ short_url_prefix + data.shortcode);  
                                    ComposeCharCheck();
...
//                                        alert($('#compose-tags').next().find('button').html());
            ...
            $(this).on('click','.reply-insert-link-btn', function(e){
                ...
                $.ajax({
                   ...
                   "success" : function (response){
                        ...
                        tweetsText.val(tweetsText.val() + " " + short_url_prefix + response.shortcode);
                        shortcode.val(response.shortcode);
                        me.closest('reply-shorturl-show-content').val(" " + short_url_prefix + response.shortcode);
                        var notif = me.closest('#caseNotification').find('.replaycontent');
                        if(notif.val() != undefined){
                            notif.val(notif.val() + " " + short_url_prefix + response.shortcode);
                        };                        
             ...
             $(".btn-compose-post").click(function() {
                ...
                else
                {
                    ...
                    if(confirmed == true){
                                        ...
                                        success: function(data)
                                        {
                                            ...
                                            if(IS_JSON == true){
                                                ...
                                                $('.compose-post-status').fadeOut(7500,function(){
                                                    ...
                                                    if(document.URL == (BASEURL + 'dashboard2/socialmedia/ComposeMessage')){
                                                        window.location.href = BASEURL + 'dashboard2/socialmedia';
                                                    }
                                               });
                                            }
                                            else{
                        ...
                        $.ajax({
                            url : BASEURL + 'dashboard2/media_stream/SocmedPost',
                            type: "POST",
                            data: {
                                    channels:channels,
                                    content:$('.compose-textbox').val(),
            ...
            $('.compose-select-campaign').on('change', function(){
                $.ajax({
                        url : BASEURL + 'dashboard2/media_stream/GetShortenUrlByCampaignId',
                        type: "GET",
                        data: {
                                campaignId:$(this).val(),
                                },
                        success: function(data){
                            ...
                            for(var x=0; x<new_data.length; x++){
                                $('.select-shorten-url').append('<option>' + short_url_prefix + new_data[x].short_code + '</option>');
                            }
                        }
                    });
            });
            ...
            $('.select-shorten-url').on('change', function(){
                $(".select-shorten-url option:selected").linkpreview({
                    url: BASEURL + 'dashboard2/media_stream/GetUrlPreview?url=' + $(".select-shorten-url option:selected").val(),
                    previewContainer: "#url-show > .compose-form > div",  //optional
                    //previewContainerClass: ".compose-schedule",
                ...
                var res = str.replace(short_url_prefix,'');
            ...
            $(this).on('click', ".destroy_status", function() {
                ...
                if(confirmStatus == true){
                    ...
                    $.ajax({
                        url : BASEURL + 'dashboard2/media_stream/ActionTwitterDelete/' + ($(this).hasClass('direct_message') == true ? '0' : '1'),
                        type: "POST",
                        data: {
             ...
             $(this).on('click','.retweet, .favorit',
                ...
                $.ajax({
                    url : BASEURL + 'dashboard2/media_stream/ActionTwitter/' + action,
                    type: "POST",
                    data: {
            ...
            $(this).on('click','.follow',
                ...
                if(confirmResult){
                    ...
                    $.ajax({
                        url : BASEURL + 'dashboard2/media_stream/ActionFollow/' + ($(this).hasClass('unfollow') ? 'unfollow' : 'follow'),
                        type: "POST",
                        data: {
                            post_id : $(this).closest('li').find('.postId').val(),
                            channel_id : $(this).closest('.floatingBox').find('input.channel-id').val()
            ...
            $(this).on('click','.fblike',
                ...
                $.ajax({
                    url : BASEURL + 'dashboard2/media_stream/FbLikeStatus',
                    type: "POST",
                    data: {
                        post_id: $(this).val(),
                        channel_id : $(this).closest('.floatingBox').find('input.channel-id').val(),
                     ...
                     $(this).on('click','.btn-send-reply',function() {
                        ...
                        if(confirmStatus == true){
                            ...
                            if(len>2000){
                               ...
                               $.ajax({
                                    url : BASEURL + 'dashboard2/media_stream/FbReplyPost',
                                    type: "POST",
                                    data: {
                                        post_id: $(this).val(),
                                        channel_id : $(this).closest('.floatingBox').find('input.channel-id').val(),
                    ...
                    if($(this).parent().siblings('.option-type').find(".productType").val() == '' && 
                       $(this).parent().siblings('.option-type').find(".replyType").val() !='Report_Abuse')
                       {
                        ...
                        if(len>2000){
                           ...
                           $.ajax({
                                url : BASEURL + 'dashboard2/media_stream/FbReplyMsg',
                                type: "POST",
                                data: {
                                    post_id: $(this).val(),
                ...
                function() {
                    ...
                    if(confirmStatus == true){
                       ...
                       if(btnDestroyStatus.hasClass('wall')){
                        ...
                        $.ajax({
                            url : BASEURL + 'dashboard2/media_stream/fbDeleteStatus/' + type_action,
                            type: "POST",
            ...
            $(this).on('click','.loadmore',
                ...
                var sampleTags = [];
                $.ajax({
                    url : BASEURL + 'dashboard2/media_stream/GetAllTags',
                    type: "GET",
                    success: function(data)
                    {
                        var new_data = JSON.parse(data);
                    ...
                    if($(this).parent().siblings('.engagement').is(":visible"))
                        $(this).parent().siblings('.reply-field').slideUp('slow');
                         ...
                         $.ajax({
                            ...
                            "success" : function(response){
                                if(response != '')
                                    $button.closest('li').find('.reply-field').html(response);
                                else
                                    $button.closest('li').find('.reply-field img').hide();
                                $button.BindMultipleSelect();
                            }
                        });
                    }
        ...
        $('.btn-dashboard-search').click(function(){
            if($('.dashboard-search-field').val() != ''){
                ...
                //window.location.href = BASEURL + 'dashboard2/search?q=' + $('.dashboard-search-field').val();
            }
            else{
    ...
    $(document).ready(function() {
        ...
        $('.compose-new-message').click(function(){
            window.location.href = BASEURL + 'dashboard2/socialmedia/ComposeMessage';
        })
...
$(document).ready(function(){
    ...
    $('#calendar').fullCalendar({
        ...
        eventSources:[
            {
                url: BASEURL + 'dashboard2/media_stream/GetScheduleData',
                type: 'GET'
            }
        ],
    ...
    $(this).on('click', '.btn-delete-schedule-post', function(){
        ...
        if(r == true){
            var me = $(this);
            $.ajax({
                url : BASEURL + 'dashboard2/media_stream/DeleteSchedulePost',
                type: "POST",
                data: {
...
$.fn.RefreshAllStream = function(){
    $('.floatingBox').each(function(){
        ...
        if(channelId != undefined){
            ...
            if($(this).closest('div').prev().find('i').attr('class') == 'icon-facebook'){
                $(this).html('&nbsp;&nbsp;Loading...');        
                $(this).load(BASEURL + 'dashboard2/media_stream/facebook_stream/' + channelId + '/' + is_read + "?uid=" + Math.random(), function(){
                ...
                $(this).html('&nbsp;&nbsp;Loading...');        
                $(this).load(BASEURL + 'dashboard2/media_stream/twitter_stream/' + channelId + '/'+ is_read + "?uid=" + Math.random(), function(){
                    $(this).find('.channel-id').val(channelId);
                    $(this).BindMultipleSelect();
                    $(this).TagItEmail();
                });
                ...
                $(this).html('&nbsp;&nbsp;Loading...');        
                $(this).load(BASEURL + 'dashboard2/media_stream/youtube_stream/' + channelId + '/'+ is_read + "?uid=" + Math.random(), function(){
                    $(this).find('.channel-id').val(channelId);
                    $(this).BindMultipleSelect();
                    $(this).TagItEmail();
                });
            ...
            if(response.type == 'twitter'){
                ...
                if(response.main_post.twitter_entities.urls.length > 0){
                 ...
                 $template2 = '<li style="display: block;">' +
                     '<img src="'+ BASEURL + 'dashboard2/media_stream/SafePhoto?photo=' + response.main_post.profile_image_url  + '" alt="" style="height: 40px;margin: 6px 10px" class="left" />' + 
                ...
                $template2 = '<li style="display: block;">' +
                '<img src="'+ BASEURL + 'dashboard2/media_stream/SafePhoto?photo=https://graph.facebook.com/' + response.main_post.author_id  + '/picture" alt="" style="height: 40px;margin: 6px 10px" class="left" />' + 
                   '<p style="padding: 0px 2px;margin: 2px 5px;width:80%" class="left">' + 
               ...
               '</li>';
                ...
                myDate.setTimezone(timezone.name());
                   $template2 = '<li style="display: block;">' +
                '<img src="'+ BASEURL + 'dashboard2/media_stream/SafePhoto?photo=https://graph.facebook.com/' + response.main_post.participant.sender.facebook_id + '/picture" alt="" style="height: 40px;margin: 6px 10px" class="left" />' + 
                   '<p style="padding: 0px 2px;margin: 2px 5px;width:80%" class="left">' + 
            ...
            for(var i=0; i<response.related_conversation.length;i++){
                if(response.related_conversation[i].type == 'twitter' || response.related_conversation[i].type == 'twitter_dm'){
                    ...
                    var text = {
                     ...
                     '<img src="'+ BASEURL + 'dashboard2/media_stream/SafePhoto?photo=' + response.related_conversation[i]['twitter_data'][0].profile_image_url  + '" alt="" style="height: 40px;margin: 6px 10px" class="left" />' + 
                        '<p style="padding: 0px 2px;margin: 2px 5px;width:80%" class="left">' + 
                    ...
                    $template = '<li style="display: block;">' +
                     '<img src="'+ BASEURL + 'dashboard2/media_stream/SafePhoto?photo=https://graph.facebook.com/' +  author_id  + '/picture" alt="" style="height: 40px;margin: 6px 10px" class="left" />' + 
                        '<p style="padding: 0px 2px;margin: 2px 5px;width:80%" class="left">' + 
                    ...
                    currentDate = new Date(response.related_conversation[i]['facebook_data'].created_at );
                    $template = '<li style="display: block;">' +
                     '<img src="'+ BASEURL + 'dashboard2/media_stream/SafePhoto?photo=https://graph.facebook.com/' + response.related_conversation[i]['facebook_data'].sender  + '/picture" alt="" style="height: 40px;margin: 6px 10px" class="left" />' + 
                        '<p style="padding: 0px 2px;margin: 2px 5px;width:80%" class="left">' + 
